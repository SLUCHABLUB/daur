...
/// To compare intervals, the [`semitones`](Interval::semitones) and [`simple`](todo) methods may be used.
#[derive(Copy, Clone, Debug)]
pub struct Interval {
    /// The number of semitones that make up the interval..
    semitones: i8,
}
